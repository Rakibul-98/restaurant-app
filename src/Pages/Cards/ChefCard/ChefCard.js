...
const ChefCard = ({ chef }) => {
    return (
        <div className='relative w-10/12 md:w-full mx-auto border-2 border-dashed h-40 sm:hover:h-[350px] md:hover:h-[420px] lg:hover:h-[365px] xl:hover:h-[440px] 2xl:hover:h-[400px] duration-1000 group mb-20 xl:mb-0'>
