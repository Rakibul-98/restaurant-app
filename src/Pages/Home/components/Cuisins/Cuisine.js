...
const Cuisine = () => {
    ...
    const cuisines = [
        {
            ...
            img: "https://i.ibb.co/Kb0ckMF/indian.jpg",
        ...
        },
        {
            ...
            img: "https://i.ibb.co/rGVhPqn/chinese.jpg",
        ...
        },
        {
            ...
            img: "https://i.ibb.co/C9xKb5k/thai.jpg",
        ...
        },
        {
            ...
            img: "https://i.ibb.co/F8L3SBq/italian.jpg",
        ...
        },
        {
            ...
            img: "https://i.ibb.co/ZSfkstV/amecican.jpg",
    ...
    const style = "py-3 border cursor-pointer";
    ...
    return (
        <div className='w-10/12 mx-auto pb-10'>
            ...
            <div className='cuisine-menu-div'>
                <ul className='grid grid-cols-5 capitalize text-center text-xs md:text-base'>
                    {
                        cuisineList.map(cl =>
                            <li key={cl.id} onClick={() => handleCuisine(`${cl.id}`)} className={state === `${cl.id}` ? `bg-green-400 text-white ${style}` : `bg-transparent ${style}`}>{cl.name}</li>
                        )
                    }
                </ul>
            </div>
