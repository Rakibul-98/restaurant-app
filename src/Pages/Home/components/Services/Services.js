...
const Services = () => {
    ...
    const services = [
        ...
        { id: 3, icon:<GrCafeteria/>, name: "Dine In", text: "Whether you're seeking an intimate dinner for two or a gathering with friends and family, our attentive staff is dedicated to ensuring your comfort and satisfaction. " },
